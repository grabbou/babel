...
proto.tensors.Attribute.prototype.getModule = function () {
    return /** @type{?proto.tensors.Module} */ (jspb.Message.getWrapperField(this, proto.tensors.Module, 3));
};
...
proto.tensors.Attribute.prototype.getTensor = function () {
    return /** @type{?proto.tensors.Tensor} */ (jspb.Message.getWrapperField(this, proto.tensors.Tensor, 4));
};
